                        ...
                        <div class="primary-menu">
                            <ul class="menu">
                                ...
                                <li class="menu-item menu-item-has-children has-megamenu">
                                  <li><a href="index-2.html">Belanja</a></li>
            ...
            <div id="main-content" class="main-content">
                ...
                <div class="sumary-product single-layout">
                    ...
                    <div class="product-attribute">
                        ...
                        <span class="sku">Coffee</span>
                        <p class="excerpt">Tes</p>
                        <div class="price">
                            <ins><span class="price-amount"><span class="currencySymbol">Rp.</span>4.321</span></ins>
                        </div>
                ...
                <div class="product-tabs single-layout biolife-tab-contain">
                    ...
                    <div class="tab-content">
                        <div id="tab_1st" class="tab-contain desc-tab active">
                            ...
                            <div class="desc-expand"><p class="desc">
                               </p>
                ...
                <div class="product-related-box single-layout">
                    <div class="biolife-title-box lg-margin-bottom-26px-im">
                        ...
                        <span class="subtitle">Semua produk terbaik ada untuk anda</span>
                                ...
                                <ul class="contact-lines">
                                    ...
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Email:  arilgunawan007.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-clock"></i>
                                            <b class="desc">Jam Buka: Senin-Kamis 08.00 pagi - 09.00 malam</b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
